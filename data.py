class Data:
    p = 0.7  # коэффициент испарения
    t0 = 2  # начальное значение феромонов
    iteration = 4  # количество итераций
    ants_number = 7  # Количество муравьев

    ALPHA = 5.0  # коэффициент влияния феромонов
